...
def fileList(path_before : str)->list :
    ...
    for file in file_list:
        ...
        category.append('_'.join(temp_list[0:3])) #리스트의 -2 인덱싱 데이터를 category에 추가
...
def moveFile(path_before, path_after):
    ...
    for file in filelist:
        ...
        dict[file]='_'.join(temp_list[0:3])
...
if __name__ == "__main__" :
    #분류할 파일이 있는 위치 폴더
    path_before = r"/Users/euno/Desktop/CodeTest/fileOrgarnize/kia"
    file_list = fileList(path_before)

    #옮길 경로 폴더
    path_after = r"/Users/euno/Desktop/CodeTest/fileOrgarnize/orgarnized"
